...
import bigappcompany.com.tissu.activity.ImageSlide;
import bigappcompany.com.tissu.model.DescriptinSliderModel;

/**
 * @author Samuel Robert <sam@spotsoon.com>
 * @created on 25 Sep 2017 at 7:37 PM
 */
...
public class ImageSlidePagerAdapter extends PagerAdapter {
	...
	public void setData(ArrayList<DescriptinSliderModel> res, Context context, ImageSlide activity) {
		this.models = res;
